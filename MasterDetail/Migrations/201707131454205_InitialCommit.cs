    ...
    public partial class InitialCommit : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .Index(t => t.InventoryItemCode, name: "AK_InventoryItem_InventoryItemCode")
                .Index(t => t.InventoryItemName, name: "AK_InventoryItem_InventoryItemName")
            ...
            Sql(@"CREATE FUNCTION dbo.GetSumOfPartsAndLabor(@WorkOrderId INT)
                    ...
                    SELECT @partsSum=SUM(ExtendedPrice) From Dbo.Parts WHERE WorkOrderId=@WorkOrderId;
                    SELECT @laborSum=SUM(ExtendedPrice) From Dbo.Labors WHERE WorkOrderId=@WorkOrderId;
                    RETURN ISNULL(@partsSum,0)+ISNULL(@laborSum,1);
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    WorkOrderId = c.Int(nullable: false),
                    InventoryItemCode = c.String(maxLength: 15),
                    InventoryItemName = c.String(nullable: false, maxLength: 80),
                    UnitPrice = c.Decimal(nullable: false, precision: 18, scale: 2),
                ...
                .ForeignKey("dbo.WorkOrders", t => t.WorkOrderId, cascadeDelete: true)
                .Index(t => new { t.WorkOrderId, t.InventoryItemCode }, name: "AK_Part");
